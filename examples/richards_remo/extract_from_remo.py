...
# remo_data_path = "/Volumes/Transcend/remo-data/data/"
remo_data_path = "/home/stud/reum/fuer_yorick/data"

i, j = 60, 70  # 60, 70 --> lat = 53.275978, lon = 10.553134


def remo_constants():
    filename_bclapp_2 = os.path.join(remo_data_path, "bclapp2.nc_remap.nc")
    ...
    filename_fmpot_2 = os.path.join(remo_data_path, "fmpot2.nc_remap.nc")
    ...
    filename_fksat_2 = os.path.join(remo_data_path, "fksat2.nc_remap.nc")
    ...
    filename_vpor_2 = os.path.join(remo_data_path, "vpor2.nc_remap.nc")
...
def remo_wsi_layers_to_csv():
    ...
    filename_wsi2 = os.path.join(remo_data_path, "wsi_1-5_2_remap.nc")
